  ...
  return (
    <>
      <Show when={props.footer?.showFooter === undefined || props.footer?.showFooter === null || props.footer?.showFooter === true}>
        ...
        >
          {props.footer?.text ?? 'This is a test version. Answers may not be correct. Visit the stonebranch documentation for more information'}
          <a
            ref={liteBadge}
            href={props.footer?.companyLink ?? 'https://stonebranch.com'}
            target="_blank"
          ...
          >
            <span>&nbsp;{props.footer?.company ?? 'stonebranch'}</span>
          </a>
        </span>
      </Show>
